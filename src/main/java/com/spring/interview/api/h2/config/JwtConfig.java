package com.spring.interview.api.h2.config;


import com.spring.interview.api.h2.filter.JwtAuthenticationFilter;
...
public class JwtConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .disable()
                .authorizeRequests()
                .antMatchers("/api/**").permitAll()//only allow this endpoint without authentication
